...
router.register(r'duenios', views.DueñoViewSet)
router.register(r'mascotas', views.MascotaViewSet)
router.register(r'fichadesparacitacion', views.FichaDesparacitacionViewSet)
router.register(r'estadisticasreportes', views.EstadisticasReportesViewSet)
router.register(r'empleados', views.EmpleadoViewSet)
router.register(r'facturacionpagos', views.FacturacionPagosViewSet)
router.register(r'facturacionproductosmedicamentos', views.FacturacionProductosMedicamentosViewSet)
router.register(r'productosmedicamentos', views.ProductosMedicamentosViewSet)
